    ...
    h = {
      ...
      images: function () {
        ...
        i.each(function () {
          ...
          n = this;
          if (t.data(this, 'processed')) s.image._scale(n, i),
          s.image._center(n, i);
           else {
            var e = new Image;
            e.onload = function () {
    ...
    l = {
      ...
      _events: function () {
        s.$el.on('click', s.options.elements.pagination + ' a', function (i) {
          ...
          t !== s.current && s.animate(t, function () {
            s.start()
          })
        })
      }
...
function (t, e) {
  'function' == typeof define && define.amd ? define('isotope/item', [
    'outlayer/outlayer'
...
function (t, e) {
  'function' == typeof define && define.amd ? define('isotope/layout-mode', [
    'get-size/get-size',
    'outlayer/outlayer'
...
function (t, e) {
  'function' == typeof define && define.amd ? define('isotope/layout-modes/masonry', [
    '../layout-mode',
    'masonry/masonry'
...
function (t, e) {
  'function' == typeof define && define.amd ? define('isotope/layout-modes/fit-rows', [
    '../layout-mode'
...
function (t, e) {
  'function' == typeof define && define.amd ? define('isotope/layout-modes/vertical', [
    '../layout-mode'
...
function (t, e) {
  ...
  './layout-modes/vertical'], function (i, n, o, r, s, a) {
  ...
  l._bindArrangeComplete = function () {
    function t() {
      e && i && n && o.dispatchEvent('arrangeComplete', null, [
        o.filteredItems
      ])
    }
    var e,
  ...
  l._filter = function (t) {
    ...
    ], r = this._getFilterTest(e), s = 0; s < t.length; s++) {
      var a = t[s];
      if (!a.isIgnored) {
        var u = r(a);
        u && i.push(a),
